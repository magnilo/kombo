                    ...
                    <form action="{{ route('faqs.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="question" id="question" value="{{ old('question') }}"
                                   ...
                                   required placeholder="Manfaat menjadi anggota?">
                        </div>

                        <div>
                            <label for="answer" class="block text-xs font-semibold text-gray-700 mb-1.5 uppercase tracking-wide">Jawaban</label>
                            <textarea name="answer" id="answer" rows="5" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required></textarea>
                        </div>
